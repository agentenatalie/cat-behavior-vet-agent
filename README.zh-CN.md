<h1 align="center">猫行为兽医咨询 Skill</h1>
...
`猫行为兽医咨询 Skill` 用来让 AI 编程助手按循证兽医行为 consult 流程处理猫和伴侣动物行为问题。它会引导 intake、检索本地兽医行为文献、可选使用 Zotero MCP 或 PaperQA2、有 web access 时搜索真实案例，并输出带引用的回答。
